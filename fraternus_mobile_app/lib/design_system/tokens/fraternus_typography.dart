...
abstract final class FraternusTypography {
  ...
  static TextStyle h1({Color color = FraternusColors.ink}) => _display(
    fontSize: 76,
  ...
  static TextStyle h2({Color color = FraternusColors.ink}) => _display(
    fontSize: 34,
    fontWeight: FontWeight.w700,
    height: 1.1,
    color: color,
  ...
  static TextStyle h3({Color color = FraternusColors.ink}) => _display(
    fontSize: 22,
  ...
  static TextStyle h4({Color color = FraternusColors.ink}) => _display(
    fontSize: 18,
    fontWeight: FontWeight.w600,
    height: 1.25,
    color: color,
  ...
  static TextStyle bodyLg({Color color = FraternusColors.ink}) => _body(
    fontSize: 19,
  ...
  static TextStyle body({Color color = FraternusColors.ink}) => _body(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    height: 1.55,
    color: color,
  ...
  static TextStyle small({Color color = FraternusColors.ink}) => _body(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    height: 1.5,
    color: color,
  ...
  static TextStyle caption({Color color = FraternusColors.ink}) => _body(
    fontSize: 13,
    fontWeight: FontWeight.w400,
    height: 1.4,
    color: color,
